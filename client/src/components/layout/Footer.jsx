export default function Footer() {
  return (
    <footer style={{ backgroundColor: '#387A74' }} className="text-white" role="contentinfo" aria-label="footer">
      ...
      <div style={{ backgroundColor: '#387A74' }} className="border-t border-white/20">
