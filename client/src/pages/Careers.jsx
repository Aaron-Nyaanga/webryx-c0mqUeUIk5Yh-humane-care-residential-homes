...
const POSITION_DEFS = [
  ...
  { slug: 'cna', title: 'Certified Nursing Assistant (CNA)', type: 'Part-time or Full-time', description: 'Deliver hands-on personal care and support to residents, including assistance with bathing, grooming, mobility, and meals, while monitoring health status and reporting changes to nursing staff.', requirements: ['Valid CNA certification in Virginia', 'CPR/First Aid certification preferred', 'Experience with adults with disabilities a plus', 'Reliable, compassionate, and team-oriented'] },
